...
// function imgtext(imgsrc, heading ) {
//   return (
//     <div>
//       <div className=" mt-[15rem] lg:mt-[10rem] flex lg:flex-row-reverse flex-col-reverse justify-between gap-5">
//         <motion.div
//           initial="hidden"
//           whileInView="visible"
//           viewport={{ once: true }}
...
//         >
//           <img
//             className="lg:w-[400px] lg:ml-[-2rem] mt-[5rem] lg:mt-0"
//             src={imgsrc}
//             alt="imgtext Image"
//           />
//         </motion.div>
//         <div className="flex-1 ">
//           <h4 className="flex  font-bold gradient justify-center lg:justify-start text-[1rem] lg:text-[1.3rem]">
//             imgtext US
//           </h4>
...
//             <Link href="/team">
//               <Primarybutton text={"More imgtext Us"} />
//             </Link>
//           </div>
//         </div>
//       </div>
